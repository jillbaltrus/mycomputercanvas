export default [
      ...
      },
  {
    ...
    description:
      "This was a fun image to make! I first found a portrait of a woman poking her own face. Then I selected a rectangle next to her fingertip and shifted it left, to make it look like it was sliding back. I had to do some surgery, so to speak, to blend the surrounding area and make it look normal.",
    type: "ART",
    year: 2022,
    otherImages: [],
  },
  {
    ...
    description:
      "This is an image I made last summer inspired by one of my favorite cocktails, the Fishbowl. To make it, I used Photoshop to partially erase images of a Svedka bottle, betta fish, and colorful pebbles, and then reshaped and combined them into a cohesive singular image.",
    type: "ART",
    year: 2022,
    otherImages: [],
  },
  ...
  },
  {
    ...
    description:
      "I created this image by cutting out a portrait and then overlaying a newspaper texture. I used a simple clouds background and added butterfly stickers on top. I then blended butterfly wings onto the eyelashes.",
    type: "ART",
    year: 2022,
    otherImages: [],
  },
  ...
  },
  {
    id: 10,
    title: "Honeycrisp",
    image: "images/bitten.jpg",
    description:
      "To make this image, I started with a model portrait I liked. Then I found images of apples with bites taken out of them, cut the bites out of the pictures of the apples, pasted them on the model, and removed the parts of her body around the bites. I then cleaned up the image and blended the pieces together to make it seamless.",
    type: "ART",
    year: 2019,
    otherImages: [],
  },
  ...
  {
    id: 6,
    title: "Sweetest Treat",
    image: "images/icecream.jpg",
    description:
      "I found a nice picture of an ice cream cone, cut it out, and copied it a bunch of times. For the background cones, I deleted the image itself and simply colored within its outline. For the center cone, I added a diamond texture with a light opacity and special blend mode to make the ice cream look diamond-y.",
    type: "ART",
    year: 2022,
    otherImages: [],
  },
  {
    ...
    description:
      "This image began as a picture I took of a cow. The patterns all come from rugs or tile patterns I found online (mostly on Amazon). I screenshotted the patterns I liked. I erased the background from the cow image and divided the cow itself into distinct areas of similar colors. I then replaced each area with a tile/rug pattern.",
    type: "ART",
    year: 2022,
    otherImages: [],
  },
  {
    ...
    description:
      "To make this image, I placed an ocean texture behind the portrait. I then erased the portrait where I wanted the water to show, in the straight line and the right eye. Then I overlaid the handwritten words and changed the blend mode to give it a glow.",
    type: "ART",
    year: 2022,
    otherImages: [],
  },
  {
    ...
    type: "TECH",
    year: 2023,
    otherImages: ["images/everythingceltics2.png"],
  },
  {
    id: 14,
    title: "Sachi",
    ...
    description:
      "This is my friend Sachi! This started as a real picture of her, and then I doodled over it on my iPad with an Apple Pencil. I colored over small patches of similar colors, used a pencil texture to draw her hair, and a watercolor tool to draw the wine glass.",
    type: "ART",
    year: 2023,
    otherImages: [],
  },
